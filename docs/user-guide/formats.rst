...
.. code-block:: python
    ...
    metadata = json.loads(pq.read_metadata('raw_data.parquet').metadata[b'battery_metadata'])
...
and times are stored as floating point numbers, rather than Parquet's native time formats.
